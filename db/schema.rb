...
ActiveRecord::Schema.define(version: 2020_04_29_223143) do

  create_table "medics", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.integer "speciallity_id"
    t.index ["speciallity_id"], name: "index_medics_on_speciallity_id"
  end
  ...
  create_table "speciallities", force: :cascade do |t|
    t.string "name"
    t.integer "charge"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  ...
  add_foreign_key "medics", "speciallities"
