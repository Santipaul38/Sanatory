...
class MedicsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create medic" do
    assert_difference('Medic.count') do
      post medics_url, params: { medic: { name: @medic.name, speciallity: @medic.speciallity } }
    end
  ...
  test "should update medic" do
    patch medic_url(@medic), params: { medic: { name: @medic.name, speciallity: @medic.speciallity } }
